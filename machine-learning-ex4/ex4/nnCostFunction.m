...
J = unreg_cost = 1/m * sum(sum(((-y_matrix .* log(a3) - (1 - y_matrix) .* log(1 - a3)))))
...
reg_cost = 0.5 * lambda * 1/m * ((sum(sum(Theta1r .* Theta1r))) + (sum(sum(Theta2r .* Theta2r))))
